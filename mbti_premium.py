...
<div class="info-box fade-in">
    <h4>🎓 건양대학교 전과 적성 진단 질문지</h4>
    <ul>
        <li>📌 안내문

본 질문지는 건양대학교 재학생의 전과 준비를 지원하기 위해 제작되었습니다.
학생 개개인의 성향 및 학습 스타일을 간단히 파악하여,
전과가 가능한 학과 중 학생에게 적합한 전공 방향을 예비적으로 제시하는 것을 목적으로 합니다.

아래의 내용을 확인한 후 응답해 주시기 바랍니다.
	1.	각 문항은 현재 본인의 모습을 기준으로 선택해 주십시오.
	2.	응답은 가급적 첫 느낌에 가장 가까운 항목으로 선택하는 것을 권장합니다.
	3.	질문지 결과는 전과 지원의 자격 및 선발 여부와 무관하며,
학생의 전공 탐색을 돕기 위한 참고용 자료로 제공됩니다.
	4.	모든 문항에 응답할 경우, 입력된 답변을 기반으로
학생의 성향 분석에 따른 전공 추천 결과가 안내됩니다.
